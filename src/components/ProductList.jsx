...
function ProductList({ onHomeClick }) {
    ...
    const styleObj = { backgroundColor: '#0880d1ff', color: '#fff!important', padding: '15px', display: 'flex', justifyContent: 'space-between', alignIems: 'center', fontSize: '20px', }
        ...
        <div>
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                <h3 style={{ color: 'white' }}>Zyora Storefront</h3>
                                <i style={{ color: 'white' }}>Shop Smart. Live Better</i>
                            </div>
                        </a>
                    </div>
                ...
                <div style={styleObjUl}>
                    <div> <a href="#" onClick={(e) => handlePlantsClick(e)} style={styleA}>Everyday Essentials, Redefined.</a></div>
